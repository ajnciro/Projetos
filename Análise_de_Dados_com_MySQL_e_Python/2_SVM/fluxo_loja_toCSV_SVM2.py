...
import pandas as pd
import random
import start_loja_db_SVM2 as stl
...
list_aq = pd.read_csv(r"{}".format(dir)+"CSVLojaSVM2/list_aq.csv")
...
df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLojaSVM2\venda_{}.csv'.format("svm2"))
query_save="SELECT * FROM produto"
df_save = pd.read_sql(query_save, mydb)
df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLojaSVM2\produto_{}.csv'.format("svm2"))
query_save="SELECT * FROM departamento"
df_save = pd.read_sql(query_save, mydb)
df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLojaSVM2\departamento_{}.csv'.format("svm2"))
query_save="SELECT * FROM aquisicao"
df_save = pd.read_sql(query_save, mydb)
df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLojaSVM2\aquisicao_{}.csv'.format("svm2"))

print("Arquivos Salvos -- {}".format("svm2"))