...
import pandas as pd
import random
import start_loja_db_SVM as stl
...
df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLojaSVM\venda_{}.csv'.format("svm"))
query_save="SELECT * FROM produto"
df_save = pd.read_sql(query_save, mydb)
df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLojaSVM\produto_{}.csv'.format("svm"))
query_save="SELECT * FROM departamento"
df_save = pd.read_sql(query_save, mydb)
df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLojaSVM\departamento_{}.csv'.format("svm"))
query_save="SELECT * FROM aquisicao"
df_save = pd.read_sql(query_save, mydb)
df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLojaSVM\aquisicao_{}.csv'.format("svm"))

print("Arquivos Salvos -- {}".format("svm"))