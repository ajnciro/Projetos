...
import pandas as pd
import random
import start_loja_db_Optm as stl
...
df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLojaOpt\venda_{}.csv'.format("opt"))

query_save="SELECT * FROM produto"
df_save = pd.read_sql(query_save, mydb)
df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLojaOpt\produto_{}.csv'.format("opt"))

query_save="SELECT * FROM departamento"
df_save = pd.read_sql(query_save, mydb)
df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLojaOpt\departamento_{}.csv'.format("opt"))

print("Arquivos Salvos -- {}".format("opt"))