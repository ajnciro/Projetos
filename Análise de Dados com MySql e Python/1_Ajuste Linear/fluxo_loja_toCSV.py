...
for x in range (10,100):
    ...
    df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLoja\venda_{}.csv'.format(lucro))
    
    query_save="SELECT * FROM produto"
    df_save = pd.read_sql(query_save, mydb)
    df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLoja\produto_{}.csv'.format(lucro))
    
    query_save="SELECT * FROM departamento"
    df_save = pd.read_sql(query_save, mydb)
    df_save.to_csv(r'C:\Users\sucod\OneDrive\Lenovo\Documentos\Sql\CSVLoja\departamento_{}.csv'.format(lucro))
